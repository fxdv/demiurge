...
echo "Track B verify (full):     ./scripts/track-b-verify.sh"
echo "Track B verify (quick):    ./scripts/track-b-verify.sh --quick"
echo "Track B benches only:      ./scripts/track-b-bench.sh"
