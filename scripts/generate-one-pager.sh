...
lines = [
    ...
    "implemented and gated locally; Track B kernel dataplane **partial** (XDP veth + io_uring micro-bench);",
    "production exit gates (real NIC, io_uring TCP serve) and fleet economics remain **Track B/C**.",
    "",
    "## Validation",
    "",
    f"| Check | Result |",
